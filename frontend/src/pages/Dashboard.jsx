          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
            <div>
              ...
              <p className="text-blue-200 text-sm">
                Manage your resumes, cover letters, ATS scores and account.
              </p>
            </div>
                      ...
                      >
                        ...
                        <td className="px-4 py-4 flex gap-2">
                          ...
                          <div className="relative group">
                            <button className="px-3 py-1 text-xs font-semibold border border-slate-200 rounded-lg hover:bg-slate-100 transition">
                              Download ▼
                            </button>
                            <div className="hidden group-hover:block absolute right-0 mt-1 bg-white border border-slate-200 rounded-lg shadow-lg z-10 min-w-[120px]">
                              ...
                              <button
                                onClick={() =>
                                  handleDownloadResume(resume, 'json')
                                }
                                className="block w-full text-left px-4 py-2 text-xs hover:bg-slate-50"
                              >
                                📋 JSON
            ...
            <div className="space-y-5">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 rounded-2xl border border-slate-200 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-100 transition"
                >
                  Change Password
                </button>
              </div>
